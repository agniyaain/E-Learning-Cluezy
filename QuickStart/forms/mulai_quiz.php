...
if (!isset($_SESSION['id_session'])) {
    ...
    mysqli_query($koneksi, "INSERT INTO quiz_session(id_quiz, status_play) VALUES ('$id_quiz', 'solo')");
    $id_session = mysqli_insert_id($koneksi);


    mysqli_query($koneksi, "INSERT INTO user_session (id_user, id_session, waktu_join, nilai)
    VALUES ('$id_user', '$id_session', NOW(), 0)");
