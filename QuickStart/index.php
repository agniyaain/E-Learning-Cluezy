    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li><a href="#tips&trick">Tips Trick</a></li>
        </ul>
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="100">
            <p class="who-we-are">What is Cluezy?</p>
            <h3>Cluezy - Web E-Learning</h3>
            <p class="fst-italic">
              Cluezy is a web-based e-learning platform designed with a cute, lightweight, and easy-to-use interface. This platform is suitable for students who want to learn in a way that is:
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> <span>Independent</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Flexible</span></li>
              <li><i class="bi bi-check-circle"></i> <span>Fun</span></li>
            </ul>
          </div>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item item-cyan position-relative">
              ...
              <div>
                ...
                <a href="forms/login.php" class="read-more stretched-link">Check It Out<i class="bi bi-arrow-right"></i></a>
              </div>
            </div>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item item-orange position-relative">
              ...
              <div>
                ...
                <a href="forms/login.php" class="read-more stretched-link">Try It <i class="bi bi-arrow-right"></i></a>
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
            <div class="service-item item-teal position-relative">
              ...
              <div>
                ...
                <a href="forms/login.php" class="read-more stretched-link">Plan Now<i class="bi bi-arrow-right"></i></a>
              </div>
            </div>
          </div><!-- End Service Item -->
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="400">
            <div class="service-item item-red position-relative">
              ...
              <div>
                ...
                <a href="forms/login.php" class="read-more stretched-link">Start Now<i class="bi bi-arrow-right"></i></a>
              </div>
            </div>
          </div><!-- End Service Item -->
        </div>
